...
```
cd existing_repo
git remote add origin https://code.dev.ai-cloud.me/bfsi-na-ai-incubation-team/ai-incubation-storage.git
git branch -M main
...
- [ ] [Set up project integrations](https://code.dev.ai-cloud.me/bfsi-na-ai-incubation-team/ai-incubation-storage/-/settings/integrations)
...
- Integration with enterprise tools:
  ...
  - CI/CD hooks
>>>>>>> 305d479 (Initial commit from Cloud Shell)
